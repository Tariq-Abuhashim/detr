...
# Example usage
merge_datasets(
    '/home/mrt/dev/detr/data/merged_dataset/merged_annotations.json', # data1 annotations
    '/home/mrt/dev/detr/data/lmatch/cleaned_lmatch_annotations.json',  # data2 annotations
    '/home/mrt/dev/detr/data/merged_dataset/images',  # data1 images
    '/home/mrt/dev/detr/data/lmatch/images',  # data2 images
    '/home/mrt/dev/detr/data/merged_dataset/'# merged pot
)
